...
var _default = {
  name: 'ModalContent',
  props: ['open', 'modalStyle', 'title', 'id', 'type', 'taskCat'],
  data: function data() {
    return {
      newTitle: null,
      cats: null
  ...
  mounted: function mounted() {
    ...
    (0, _axios.default)({
      ...
      console.log(_this.cats, 'Dari edit');
    }).catch(function (err) {
...
},{"axios":"../node_modules/axios/index.js","_css_loader":"../../../../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/css-loader.js","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../src/components/modals/ModalBtn.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  name: 'Modal-btn',
  props: ['id', 'title', 'type', 'cats', 'taskCat'],
  data: function data() {
    return {
      showModal: false,
      modalStyle: {
                ...
                _c(
                  "ModalBtn",
                  {
                    attrs: {
                      id: task.id,
                      title: task.title,
                      taskCat: task.CategoryId,
                      type: "edit"
                    },
                    on: {
                      backToCard: function($event) {
                        return _vm.getUpdate(task.id, $event, _vm.cats)
                      }
                    }
                  },
                  [
    ...
    getAll: function getAll() {
      ...
      (0, _axios.default)({
        ...
        _this2.tasks.forEach(function (el, i) {
          ...
          console.log(_this2.cats, _this2.cats2, 'y');
        });
      }).catch(function (err) {
        console.log(err);
          ...
          return _c("div", { key: cat.id, staticClass: "col s12 m6 l4" }, [
            _c(
              ...
              [
                ...
                _vm._v(" "),
                _c("Card", {
                  attrs: { catTasks: cat.Tasks, cats: _vm.listEachRow },
                  on: {
...
exports.default = _default;
  ...
  return _c(
    ...
    [
      _c("NavBar", {
        attrs: { isLogin: _vm.isLogin, withGoogle: _vm.withGoogle },
...
},{"./components/navbar/NavBar":"../src/components/navbar/NavBar.vue","./components/CardList":"../src/components/CardList.vue","./components/user/login":"../src/components/user/login.vue","./components/user/register":"../src/components/user/register.vue","vue-hot-reload-api":"../node_modules/vue-hot-reload-api/dist/index.js","vue":"../node_modules/vue/dist/vue.runtime.esm.js"}],"../node_modules/vue-toasted/dist/vue-toasted.min.js":[function(require,module,exports) {
var define;
